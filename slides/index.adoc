...
- Simple assertions/predicates
- Only need the caveat id: String
...
- Must be discharged by a special _discharging_ macaroon
- caveat id, caveat location and caveat verifier key
